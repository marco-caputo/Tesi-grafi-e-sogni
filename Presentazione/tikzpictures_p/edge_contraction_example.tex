\begin{tikzpicture}
  ...
  % Left Graph
  \node[vertex, line width=1.9pt, draw=orangeUnicam, label=left:$u$] (u) at (0, 1) {};
  \node[] (u2) at (-0.2, 0.8) {};
  \node[vertex, line width=1.9pt, draw=orangeUnicam, label=left:$v$] (v) at (0, -1) {};
  \node[] (v2) at (-0.2, -0.8) {};
  ...
  \draw[edge, line width=1.7pt, draw=orangeUnicam] (u) -- (v);
  \draw[->, red] (u2) -- ++( 0, -0.5);
  \draw[->, red] (v2) -- ++( 0, 0.5);

  % Right Graph
  \node[vertex, line width=1.9pt, draw=orangeUnicam, label=left:$w$] (w) at (6, 0) {};
