...
\draw  [color={rgb, 255:red, 255; green, 255; blue, 0 }  ,draw opacity=1 ][line width=2.25]  (2.14,95.57) .. controls (2.14,43.66) and (58.55,1.57) .. (128.14,1.57) .. controls (197.73,1.57) and (254.14,43.66) .. (254.14,95.57) .. controls (254.14,147.49) and (197.73,189.57) .. (128.14,189.57) .. controls (58.55,189.57) and (2.14,147.49) .. (2.14,95.57) -- cycle ;
%Curve Lines [id:da9916896653167908]
\draw [color={rgb, 255:red, 255; green, 255; blue, 0 }  ,draw opacity=1 ][line width=2.25]    (30.14,153.57) .. controls (79.86,141.57) and (142.86,99.57) .. (133.86,-1.43) ;
%Curve Lines [id:da16207253703394464]
\draw [color={rgb, 255:red, 255; green, 255; blue, 0 }  ,draw opacity=1 ][line width=2.25]    (233.86,146.57) .. controls (224.86,122.57) and (151.86,96.57) .. (113.86,94.57) ;

% Text Node
\draw (19,8.4) node [anchor=north west][inner sep=0.75pt]    {$\textcolor[rgb]{0.92,0.92,0.06}{\mathbf{A}}$};
% Text Node
\draw (228,8.4) node [anchor=north west][inner sep=0.75pt]    {$\textcolor[rgb]{0.92,0.92,0.06}{\mathbf{B}}$};
% Text Node
\draw (217,168.4) node [anchor=north west][inner sep=0.75pt]    {$\textcolor[rgb]{0.92,0.92,0.06}{\mathbf{C}}$};


% Define nodes in the condensed graph
\node[graph node, fill=yellow!30, draw=black] (A) at (340,100) {A};
\node[graph node, fill=yellow!30, draw=black] (B) at (400,50) {B};
\node[graph node, fill=yellow!30, draw=black] (C) at (400,150) {C};
