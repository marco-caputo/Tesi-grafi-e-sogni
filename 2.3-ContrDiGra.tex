...
loro secondo il concetto di raffinamento: una relazione di equivalenza $R_1$ si dice più \textit{fine}
...
In tal caso si dice che $R_2$ \`e più \textit{grezza} (in inglese \textit{coarser}) di $R_1$, in quanto ogni classe
